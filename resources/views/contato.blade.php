...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid lg:grid-cols-2 lg:gap-y-16 gap-10">
    ...
    <a class="group block rounded-xl overflow-hidden focus:outline-none">
      <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-7">
        <div class="shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 h-44">
        <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">Insira o seu número de telefone e o contataremos!
